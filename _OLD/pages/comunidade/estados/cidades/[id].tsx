...
import { LocalidadesData, TipoDiocesesData, TipoLocaisData } from "../../../api/cncApi"
                    ...
                    <div key={`localidade-card-${localidade.id_localidade}`} className="col">
                        <div className="card" style={{ width: "18rem" }}>
                            ...
                            <ul className="list-group list-group-flush">
                                <li className="list-group-item">{localidade.co_localidade}</li>
                                <li className="list-group-item">
                                    Diocese: {localidade.id_diocese}
                                </li>
                                <li className="list-group-item">
                                    Tipo: {tipoLocais.filter(l => l.id_tipo_local === localidade.id_tipo_local).map(local => local.no_tipo_local)}
                                </li>
                            </ul>
                            <div className="card-body">
